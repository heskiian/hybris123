...
/**
 * This attribute Mapper class maps data for attachment type attribute between {@link CatalogUnawareMediaModel} and {@link AttachmentRefOrValue}
 *
 * @since 2108
 */
public class AttachmentRefOrValueTypeAttributeMapper extends PmAttributeMapper<CatalogUnawareMediaModel, AttachmentRefOrValue>
{
	...
	{
		if (source.getMediaFormat() == null || StringUtils.isEmpty(source.getMediaFormat().getName()))
		{
			return;
		}
