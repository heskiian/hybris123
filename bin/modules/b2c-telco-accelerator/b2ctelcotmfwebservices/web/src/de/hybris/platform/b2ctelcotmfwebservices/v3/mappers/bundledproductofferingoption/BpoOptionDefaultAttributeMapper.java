...
/**
 * This attribute Mapper class maps data for number rel offer default attribute between {@link TmaBundledProdOfferOptionData} and {@link BundledProductOfferingOption}
 *
 * @since 2011
 */
public class BpoOptionDefaultAttributeMapper
		extends TmaAttributeMapper<TmaBundledProdOfferOptionData, BundledProductOfferingOption>
{
			...
			final BundledProductOfferingOption target, final MappingContext context)
	{
		...
		{
			target.setNumberRelOfferDefault(source.getDefaultValue());
		}
	}
}
