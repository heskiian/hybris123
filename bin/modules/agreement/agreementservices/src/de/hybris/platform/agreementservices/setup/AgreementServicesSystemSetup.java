 ...
 */
package de.hybris.platform.agreementservices.setup;

import de.hybris.platform.agreementservices.constants.AgreementservicesConstants;
 ...
 * @since 2108
 */
@SystemSetup(extension = AgreementservicesConstants.EXTENSIONNAME)
public class AgreementServicesSystemSetup extends AbstractSystemSetup
{
	...
	private void importTestData()
	{
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/apidata/oauthclients.impex",
						AgreementservicesConstants.EXTENSIONNAME), false);
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/apidata/agreement.impex",
						AgreementservicesConstants.EXTENSIONNAME), false);
