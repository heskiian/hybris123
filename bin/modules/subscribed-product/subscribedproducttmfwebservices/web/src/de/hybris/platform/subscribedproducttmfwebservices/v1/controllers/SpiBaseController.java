 ...
 * @since 2105
 */
public abstract class SpiBaseController
{
	private static final Logger LOG = Logger.getLogger(SpiBaseController.class);
	...
	public void init()
	{
		objectMapper.setDateFormat(new SimpleDateFormat(Config.getParameter("subscribedproducttmfwebservices.simpleDateFormat")));
	...
	protected ResponseEntity getUnsuccessfulResponse(final String errorMessage, final Exception e, final HttpStatus httpStatus)
	{
