 ...
 */
package de.hybris.platform.b2ctelcooccaddon.controllers;
...
public class TmaCartsController extends BaseController
{
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.getCarts.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.getCart.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.createCartEntry.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.createCart.priority")
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.deleteCartEntry.priority")
	...
	@RequestMapping(value = "/{cartId}/entries/{entryNumber}", method = RequestMethod.PATCH, consumes =
			{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.updateCartEntry.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.getCartEntry.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.replaceCartEntry.priority")
	@ResponseBody
