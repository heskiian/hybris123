...
import de.hybris.platform.b2ctelcoservices.search.solrfacetsearch.provider.impl.TmaProductSpecDescriptionValueProvider;
 ...
 * @since 1810
 */
public class TmaSppPscvDescProvider extends TmaProductSpecDescriptionValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppPscvDescProvider.class);
