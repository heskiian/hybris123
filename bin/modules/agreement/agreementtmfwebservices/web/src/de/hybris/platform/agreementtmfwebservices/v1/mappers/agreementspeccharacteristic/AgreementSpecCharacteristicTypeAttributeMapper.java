...
/**
 * This attribute Mapper class maps data for type attribute between {@link AgrAgreementSpecCharacteristicModel} and
 * {@link AgreementSpecCharacteristic}
 *
 * @since 2108
 */
public class AgreementSpecCharacteristicTypeAttributeMapper
		extends AgrAttributeMapper<AgrAgreementSpecCharacteristicModel, AgreementSpecCharacteristic>
{
	public AgreementSpecCharacteristicTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
