...
package de.hybris.platform.billingaccounttmfwebservices.v1.context.impl;
 ...
 * @since 2111
 */
public class BaDefaultContextInformationLoader implements BaContextInformationLoader
{
	private static final Logger LOG = Logger.getLogger(BaDefaultContextInformationLoader.class);

	private CommonI18NService commonI18NService;
	private CommerceCommonI18NService commerceCommonI18NService;


	public BaDefaultContextInformationLoader(final CommonI18NService commonI18NService,
	...
	public LanguageModel setLanguageFromRequest(final HttpServletRequest request)
	{
		...
		final String acceptLanguageValue = request.getHeader(BillingaccounttmfwebservicesConstants.HTTP_REQUEST_HEADER_LANGUAGE);
