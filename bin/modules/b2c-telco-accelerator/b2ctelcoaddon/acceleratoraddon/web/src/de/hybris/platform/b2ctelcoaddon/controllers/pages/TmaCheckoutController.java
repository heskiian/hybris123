...
public class TmaCheckoutController extends AbstractCheckoutController
{
	private static final Logger LOG = Logger.getLogger(TmaCheckoutController.class);
	/**
	...
	public String handleModelNotFoundException(final Throwable exception, final ServletRequest request)
	{
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		orderDetails.setEntries(getTmaOrderEntryFacade().getAllSpoEntries(orderDetails));
