 ...
 */
package de.hybris.platform.b2ctelcooccaddon.jalo;

import de.hybris.platform.b2ctelcooccaddon.constants.B2ctelcooccaddonConstants;
...
/**
 * This is the extension manager of the b2ctelcooccaddon extension.
 */
public class B2ctelcooccaddonManager extends GeneratedB2ctelcooccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcooccaddonManager.class.getName());
	 ...
	 */
	public B2ctelcooccaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcooccaddonManager called.");
		}
	}
	 ...
	 */
	public static B2ctelcooccaddonManager getInstance()
	{
		return (B2ctelcooccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2ctelcooccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcooccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcooccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
