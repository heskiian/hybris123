 ...
 */
package de.hybris.platform.b2ctelcofacades.stock.impl;
...
/**
 * Default implementation of {@link TmaStockFacade}
 *
 * @since 2003
 *
 */
public class DefaultTmaStockFacade implements TmaStockFacade
{
	private BaseSiteService baseSiteService;
	private CommerceStockService commerceStockService;
	private ProductService productService;
	private PointOfServiceService pointOfServiceService;
	private TmaBaseStoreForSiteSelectorStrategy tmaBaseStoreForSiteSelectorStrategy;
	...
	public boolean isStockSystemEnabled(final String baseSiteId) throws UnknownIdentifierException //NOSONAR
	{
		...
		return getCommerceStockService().isStockSystemEnabled(tmaBaseStoreForSiteSelectorStrategy.getBaseStore(baseSiteModel));
	}

	@Override
	public StockData getStockDataFor(final String productCode, final String baseSiteId)
			throws UnknownIdentifierException, IllegalArgumentException, AmbiguousIdentifierException //NOSONAR
	{
		...
		return createStockData(getCommerceStockService().getStockLevelStatusForProductAndBaseStore(productModel,
				getTmaBaseStoreForSiteSelectorStrategy().getBaseStore(baseSiteModel)), getCommerceStockService()
				.getStockLevelForProductAndBaseStore(productModel,
						getTmaBaseStoreForSiteSelectorStrategy().getBaseStore(baseSiteModel)));
	}
	...
	{
		return tmaBaseStoreForSiteSelectorStrategy;
	}

	@Required
	public void setTmaBaseStoreForSiteSelectorStrategy(
			final TmaBaseStoreForSiteSelectorStrategy tmaBaseStoreForSiteSelectorStrategy)
	{
		this.tmaBaseStoreForSiteSelectorStrategy = tmaBaseStoreForSiteSelectorStrategy;
	}
}
