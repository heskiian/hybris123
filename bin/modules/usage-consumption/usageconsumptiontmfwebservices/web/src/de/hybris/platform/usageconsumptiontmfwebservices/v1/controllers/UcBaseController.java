 ...
 * @since 2108
 */
public class UcBaseController
{
	private static final Logger LOG = Logger.getLogger(UcBaseController.class);
	...
	{
		objectMapper
				.setDateFormat(new SimpleDateFormat(Config.getParameter("usageconsumptiontmfwebservices.simpleDateFormat")));
