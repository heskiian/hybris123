 ...
 * @since 1810
 */
public class TmaSppStockFlagProvider extends ProductInStockFlagValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppStockFlagProvider.class);
