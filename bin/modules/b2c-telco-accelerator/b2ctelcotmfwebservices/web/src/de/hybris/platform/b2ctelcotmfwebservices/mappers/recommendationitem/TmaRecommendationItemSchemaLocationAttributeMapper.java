...
/**
 * This attribute Mapper class maps data for schema location attribute between {@link TmaOfferData} and {@link RecommendationItem}
 *
 * @since 1907
 */
public class TmaRecommendationItemSchemaLocationAttributeMapper extends TmaAttributeMapper<TmaOfferData, RecommendationItem>
{
	 @Override
