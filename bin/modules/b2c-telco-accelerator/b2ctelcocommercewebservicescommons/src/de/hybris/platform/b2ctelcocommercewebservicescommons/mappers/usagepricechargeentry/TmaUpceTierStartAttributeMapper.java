...
/**
 * This attribute Mapper class maps data for tierStart attribute between {@link UsageChargeEntryData} and
 * {@link UsagePriceChargeEntryWsDTO}
 *
 * @since 1907
 */
public class TmaUpceTierStartAttributeMapper extends TmaAttributeMapper<UsageChargeEntryData, UsagePriceChargeEntryWsDTO>
{
	@Override
			...
			final MappingContext context)
	{
		...
		if (ObjectUtils.isEmpty(((TierUsageChargeEntryData) source).getTierStart()))
		{
			return;
		}

		target.setTierStart(((TierUsageChargeEntryData) source).getTierStart());
	}
}
