 ...
 */
package de.hybris.platform.billmanagementtmfwebservices.config;
...
import static de.hybris.platform.billmanagementtmfwebservices.constants.BillmanagementtmfwebservicesConstants.AUTHORIZATION_URL;
import static de.hybris.platform.billmanagementtmfwebservices.constants.BillmanagementtmfwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static de.hybris.platform.billmanagementtmfwebservices.constants.BillmanagementtmfwebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static de.hybris.platform.billmanagementtmfwebservices.constants.BillmanagementtmfwebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static de.hybris.platform.billmanagementtmfwebservices.constants.BillmanagementtmfwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
...
/**
 * Swagger Configuration for billmanagementtmfwebservices extension
 *
 * @since 2108
 */
public class SwaggerConfig
{
	private static final String PASS_AUTHORIZATION_SCOPE = "billmanagementtmfwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "billmanagementtmfwebservices.oauth2.clientCredentials.scope";
	private static final String VERSION_SCOPE = "billmanagementtmfwebservices.default.version";
