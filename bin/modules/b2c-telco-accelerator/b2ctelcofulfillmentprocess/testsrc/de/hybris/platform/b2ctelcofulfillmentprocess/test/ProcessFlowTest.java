...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2ctelcofulfillmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/b2ctelcofulfillmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/b2ctelcofulfillmentprocess/test/process/consignment-process.xml");
