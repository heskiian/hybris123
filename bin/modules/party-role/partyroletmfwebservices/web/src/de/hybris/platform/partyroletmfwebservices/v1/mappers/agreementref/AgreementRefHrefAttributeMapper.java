...
/**
 * This attribute Mapper class maps data for href attribute between {@link PrBusinessInteractionModel} and {@link AgreementRef}
 *
 * @since 2108
 */
public class AgreementRefHrefAttributeMapper extends PrAttributeMapper<PrBusinessInteractionModel, AgreementRef>
{
			...
			final MappingContext context)
	{
		...
		target.setHref(PartyroletmfwebservicesConstants.AGREEMENT_API_URL + source.getId());
	}
}
