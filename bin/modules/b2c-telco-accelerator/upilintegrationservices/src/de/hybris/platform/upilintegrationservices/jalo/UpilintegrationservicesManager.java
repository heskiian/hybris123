 ...
 */
package de.hybris.platform.upilintegrationservices.jalo;
...
/**
 * This is the extension manager of the Upilintegrationservices extension.
 */
public class UpilintegrationservicesManager extends GeneratedUpilintegrationservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(UpilintegrationservicesManager.class);
	 ...
	 */
	public static UpilintegrationservicesManager getInstance()
	{
		return (UpilintegrationservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UpilintegrationservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UpilintegrationservicesManager() // NOPMD 
	{
		LOG.debug("constructor of UpilintegrationservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of UpilintegrationservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of UpilintegrationservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
