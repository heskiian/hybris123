...
export declare class BuildCacheConfiguration {
     ...
     */
    static tryLoadAsync(terminal: ITerminal, rushConfiguration: RushConfiguration): Promise<BuildCacheConfiguration | undefined>;
    /**
     ...
     */
    static loadAndRequireEnabledAsync(terminal: ITerminal, rushConfiguration: RushConfiguration): Promise<BuildCacheConfiguration>;
