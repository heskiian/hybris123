 ...
 */
package de.hybris.platform.b2ctelcotmfwebservices.dto.error;
...
public class TmaErrorRepresentationWsDto implements Serializable
{
	 ...
	 * @return message
	 **/
	@ApiModelProperty(value = "Text that provides more details and corrective actions related to the error. This can be shown to a client user.")
