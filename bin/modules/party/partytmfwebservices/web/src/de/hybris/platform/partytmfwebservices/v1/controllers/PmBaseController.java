 ...
 * @since 2108
 */
public abstract class PmBaseController
{
	private static final Logger LOG = Logger.getLogger(PmBaseController.class);
	...
	public void init()
	{
		objectMapper.setDateFormat(new SimpleDateFormat(Config.getParameter("partytmfwebservices.simpleDateFormat")));
