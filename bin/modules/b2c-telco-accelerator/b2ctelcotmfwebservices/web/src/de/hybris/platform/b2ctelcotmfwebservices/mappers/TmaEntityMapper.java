...
/**
 * This Mapper class maps data in between TMF resource{@link SOURCE} and {@link TARGET}
 *
...
public class TmaEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	...
	/**
	 * {@inheritDoc}
	 * Populates the attributes on the target object with values of the attributes from source object, by calling the
	 * attribute mappers.
	 *
	 * @param source
	 *           the source object
	...
	/**
	 * {@inheritDoc}
	 * Populates the attributes on the source object with values of the attributes from target object, by calling the
	 * attribute mappers.
	 *
	 * @param source
	 *           the source object
	...
	@Required
	public void setAttributeMappers(
			final List<TmaAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
