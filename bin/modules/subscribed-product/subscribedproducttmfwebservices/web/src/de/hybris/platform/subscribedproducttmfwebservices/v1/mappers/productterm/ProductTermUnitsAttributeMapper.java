...
/**
 * This attribute Mapper class maps data for units attribute between {@link ProductTerm} and
 * {@link SpiProductTermModel}
 *
 * @since 2111
 */
public class ProductTermUnitsAttributeMapper extends SpiAttributeMapper<SpiProductTermModel, ProductTerm>
{
	public ProductTermUnitsAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
	...
	public void populateSourceAttributeFromTarget(final ProductTerm target, final SpiProductTermModel source,
			final MappingContext context)
	{
		if (target.getDuration() != null && StringUtils.isNotEmpty(target.getDuration().getUnits()))
		{
			source.setUnits(target.getDuration().getUnits());
		}
	}
}
