...
/**
 * This attribute Mapper class maps data for skill attribute between {@link PmIndividualModel} and {@link Individual}
 *
 * @since 2108
 */
public class IndividualSkillAttributeMapper extends PmAttributeMapper<PmIndividualModel, Individual>
{
	private final MapperFacade mapperFacade;

	public IndividualSkillAttributeMapper(final String sourceAttributeName, final String targetAttributeName,
			...
			final MappingContext context)
	{
		...
		target.setSkill(getMapperFacade().mapAsList(source.getSkills(), Skill.class, context));
	}
