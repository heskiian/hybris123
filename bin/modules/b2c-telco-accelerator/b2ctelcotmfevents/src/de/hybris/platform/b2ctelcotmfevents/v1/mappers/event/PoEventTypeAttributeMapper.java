...
/**
 * This attribute Mapper class maps data for eventType attribute between {@link TmaProductOfferingEventPayload} and
 * {@link Event}
 *
 * @since 2105
 */
public class PoEventTypeAttributeMapper extends TmaAttributeMapper<TmaProductOfferingEventPayload, Event>
{
	@Override
			...
			final MappingContext context)
	{
		...
		{
			target.setEventType(
					Config.getParameter(B2ctelcotmfresourcesConstants.TMA_PRODUCT_OFFERING_DEFAULT_REFERRED) + source.getEventType()
							.getCode());
		}
	}
}
