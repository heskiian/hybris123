...
import de.hybris.platform.b2ctelcoservices.search.solrfacetsearch.provider.impl.ProductReviewCountValueProvider;
 ...
 * @since 1810
 */
public class TmaSppReviewCntProvider extends ProductReviewCountValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppReviewCntProvider.class);
