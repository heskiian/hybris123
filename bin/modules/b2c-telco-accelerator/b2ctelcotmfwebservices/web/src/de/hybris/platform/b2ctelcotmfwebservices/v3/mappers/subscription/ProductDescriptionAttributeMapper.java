...
/**
 * This attribute Mapper class maps data for description attribute between {@link TmaSubscriptionBaseData} and
 * {@link Product}
 *
 * @since 2102
 */
public class ProductDescriptionAttributeMapper extends TmaAttributeMapper<TmaSubscriptionBaseData, Product>
{
	@Override
			...
			final MappingContext context)
	{
		...
		{
			target.setDescription(source.getSubscriberIdentity());
		}
	}
}
