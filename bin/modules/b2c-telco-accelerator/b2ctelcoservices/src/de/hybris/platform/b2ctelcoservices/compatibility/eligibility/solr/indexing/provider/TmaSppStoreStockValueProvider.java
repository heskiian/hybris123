 ...
 * @since 1810
 */
public class TmaSppStoreStockValueProvider extends ProductStoreStockValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppStoreStockValueProvider.class);
