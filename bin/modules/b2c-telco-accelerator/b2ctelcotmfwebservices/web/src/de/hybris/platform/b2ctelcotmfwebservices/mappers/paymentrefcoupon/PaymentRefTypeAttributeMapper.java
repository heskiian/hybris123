...
/**
 * This attribute Mapper class maps data for type attribute between {@link CouponData} and {@link PaymentRef}
 *
 * @since 2003
 */
public class PaymentRefTypeAttributeMapper extends TmaAttributeMapper<CouponData, PaymentRef>
{
	@Override
	public void populateTargetAttributeFromSource(CouponData source, PaymentRef target, MappingContext context)
	{
		...
		{
			target.setType(PaymentRef.TypeEnum.VOUCHER);
		}
	}
}
