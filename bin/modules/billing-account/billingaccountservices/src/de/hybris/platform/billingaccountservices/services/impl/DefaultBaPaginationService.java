...
/**
 * Default implementation of {@link BaPaginationService}.
 *
 * @since 2105
 */
public class DefaultBaPaginationService implements BaPaginationService
{
	...
	private static final String DEFAULT_PAGINATION_LIMIT = "billingaccountservices.pagination.defaultLimit";

	@Override
	public void addEntryWithPaginationDetails(final MultiValueMap<String, String> header,
	...
	{
		return Integer.valueOf(Config.getParameter(DEFAULT_PAGINATION_LIMIT));
	}
}
