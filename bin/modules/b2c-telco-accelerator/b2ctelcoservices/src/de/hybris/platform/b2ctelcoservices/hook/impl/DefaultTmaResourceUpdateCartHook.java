 ...
 * @since 1911
 */
public class DefaultTmaResourceUpdateCartHook implements TmaUpdateCartHook
{
	private TmaCommerceCartResourceService tmaCommerceCartResourceService;

	public DefaultTmaResourceUpdateCartHook(TmaCommerceCartResourceService tmaCommerceCartResourceService)
	{
		this.tmaCommerceCartResourceService = tmaCommerceCartResourceService;
	}

	@Override
	public void beforeUpdateCart(CommerceCartParameter parameter)
	{
	...
	@Override
	public void afterUpdateCart(CommerceCartParameter parameter, CommerceCartModification result)
	{
