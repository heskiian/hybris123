...
/**
 * JUnit Tests for the @{TmaUpceTierStartAttributeMapper}
 *
 */
@UnitTest
public class TmaUpceTierStartAttributeMapperTest
{
	@InjectMocks
	private final TmaUpceTierStartAttributeMapper mapper = new TmaUpceTierStartAttributeMapper();
	...
	public void testPopulateTargetAttributeFromSource() throws ParseException
	{
		...
		tierUsageChargeEntryData.setTierStart(8);
		...
		Assert.assertEquals(tierUsageChargeEntryData.getTierStart(), target.getTierStart().intValue());
	}
