...
/**
 * This attribute Mapper class maps data for href attribute between {@link SpiServiceModel} and {@link ServiceRef}
 *
 * @since 2105
 */
public class ServiceRefHrefAttributeMapper extends SpiAttributeMapper<SpiServiceModel, ServiceRef>
{
	public ServiceRefHrefAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.setHref(SubscribedproducttmfwebservicesConstants.SERVICE_API_URL + source.getId());
		}
	}
}
