...
/**
 * This attribute Mapper class maps data for type attribute between {@link TmaOfferData} and {@link Recommendation}
 *
 * @since 1907
 */
public class TmaRecommendationTypeAttributeMapper extends TmaAttributeMapper<TmaOfferData, Recommendation>
{
	 @Override
	 public void populateTargetAttributeFromSource(TmaOfferData source, Recommendation target, MappingContext context)
	 {
		  ...
		  {
				target.setType(Config.getParameter(B2ctelcotmfwebservicesConstants.RECOMMENDATION_API_OFFER_TYPE));
		  }
