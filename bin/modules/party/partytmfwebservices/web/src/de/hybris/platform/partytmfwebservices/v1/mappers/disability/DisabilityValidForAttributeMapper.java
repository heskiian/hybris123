...
/**
 * This attribute Mapper class maps data for valid for attribute between {@link PmDisabilityModel} and {@link Disability}
 *
 * @since 2108
 */
public class DisabilityValidForAttributeMapper extends PmAttributeMapper<PmDisabilityModel, Disability>
{
	public DisabilityValidForAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
