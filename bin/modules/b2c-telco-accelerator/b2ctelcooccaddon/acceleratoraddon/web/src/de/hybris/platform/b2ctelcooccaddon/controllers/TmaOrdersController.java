...
public class TmaOrdersController extends BaseController
{
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaOrdersController.placeOrder.priority")
	...
	public OrderWsDTO placeOrder(@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields,
			...
			throws OrderProcessingException, PaymentAuthorizationException, InvalidCartException
	{
		...
		if (!tmaCheckoutFacade.authorizePayment(null))
		{
