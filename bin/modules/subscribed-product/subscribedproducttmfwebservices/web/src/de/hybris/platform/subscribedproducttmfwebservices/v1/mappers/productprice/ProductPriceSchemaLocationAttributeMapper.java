...
/**
 * This attribute Mapper class maps data for atSchemaLocation attribute between {@link SpiProductPriceModel} and {@link ProductPrice}
 *
 * @since 2105
 */
public class ProductPriceSchemaLocationAttributeMapper extends SpiAttributeMapper<SpiProductPriceModel, ProductPrice>
{
	public ProductPriceSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
