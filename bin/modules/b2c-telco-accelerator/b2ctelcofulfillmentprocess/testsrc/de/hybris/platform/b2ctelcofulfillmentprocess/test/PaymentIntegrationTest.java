...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2ctelcofulfillmentprocess/test/b2ctelcofulfillmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2ctelcofulfillmentprocess/test/b2ctelcofulfillmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/b2ctelcofulfillmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/b2ctelcofulfillmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/b2ctelcofulfillmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/b2ctelcofulfillmentprocess/test/testCatalog.csv", "windows-1252");
			importCsv("/b2ctelcofulfillmentprocess/test/testPolicy.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2ctelcofulfillmentprocess/test/b2ctelcofulfillmentprocess-spring-testcleanup.xml"));
	...
	protected OrderModel placeTestOrder(final boolean valid) throws InvalidCartException, CalculationException
	{
		...
		entries.get(0).setProcessType(TmaProcessType.ACQUISITION);
		entries.get(1).setProcessType(TmaProcessType.ACQUISITION);
		entries.get(2).setProcessType(TmaProcessType.ACQUISITION);
