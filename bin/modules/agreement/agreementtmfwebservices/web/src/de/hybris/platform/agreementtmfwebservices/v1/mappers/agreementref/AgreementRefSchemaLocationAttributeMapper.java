...
/**
 * This attribute Mapper class maps data for schema location attribute between {@link AgrAgreementModel} and {@link AgreementRef}
 *
 * @since 2108
 */
public class AgreementRefSchemaLocationAttributeMapper
		extends AgrAttributeMapper<AgrAgreementModel, AgreementRef>
{
	public AgreementRefSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
