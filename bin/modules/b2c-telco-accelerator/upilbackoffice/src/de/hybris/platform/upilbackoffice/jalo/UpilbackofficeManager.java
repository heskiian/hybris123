 ...
 */
package de.hybris.platform.upilbackoffice.jalo;
...
import de.hybris.platform.upilbackoffice.constants.UpilbackofficeConstants;
 ...
 */
public class UpilbackofficeManager extends GeneratedUpilbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UpilbackofficeManager.class.getName());
	 ...
	 */
	public static UpilbackofficeManager getInstance()
	{
		return (UpilbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UpilbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UpilbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UpilbackofficeManager called.");
		}
	}
