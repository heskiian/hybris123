...
/**
 * This attribute Mapper class maps the error code between {@link TmaCartValidationData} and {@link MessageWsDTO}.
 *
 * @since 1911
 */
public class TmaCartMessageTypeAttributeMapper extends TmaAttributeMapper<TmaCartValidationData, MessageWsDTO>
{
	@Override
