 ...
 * @since 2108
 */
public abstract class AgrBaseController
{
	private static final Logger LOG = Logger.getLogger(AgrBaseController.class);
	...
	public void init()
	{
		objectMapper.setDateFormat(new SimpleDateFormat(Config.getParameter("agreementtmfwebservices.simpleDateFormat")));
