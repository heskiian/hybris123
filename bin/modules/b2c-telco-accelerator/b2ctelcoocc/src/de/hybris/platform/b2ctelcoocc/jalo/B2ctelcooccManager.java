 ...
 */
package de.hybris.platform.b2ctelcoocc.jalo;
...
/**
 * This is the extension manager of the b2ctelcoocc extension.
 */
public class B2ctelcooccManager extends GeneratedB2ctelcooccManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcooccManager.class.getName());
	 ...
	 */
	public B2ctelcooccManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcooccManager called.");
		}
	}
	 ...
	 */
	public static B2ctelcooccManager getInstance()
	{
		return (B2ctelcooccManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2ctelcooccConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcooccManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcooccManager called, current tenant: " + getTenant().getTenantID());
		}
	}
