 ...
 */
package de.hybris.platform.b2ctelcofulfillmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(B2ctelcofulfillmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(B2ctelcofulfillmentprocessConstants.PARENT_PROCESS);
