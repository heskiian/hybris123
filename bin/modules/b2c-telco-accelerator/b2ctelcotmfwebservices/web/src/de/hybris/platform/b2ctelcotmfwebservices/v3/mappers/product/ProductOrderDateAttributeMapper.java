...
/**
 * This attribute Mapper class maps data for orderDate attribute between {@link TmaSubscribedProductData} and
 * {@link Product}
 *
 * @since 2102
 */
public class ProductOrderDateAttributeMapper extends TmaAttributeMapper<TmaSubscribedProductData, Product>
{
	@Override
	public void populateTargetAttributeFromSource(final TmaSubscribedProductData source, final Product target,
			final MappingContext context)
	{
		if (!ObjectUtils.isEmpty(source.getStartDate()))
		{
			target.setOrderDate(source.getStartDate());
		}
	}
}
