...
public class DefaultOutboundSyncJobRegister implements OutboundSyncJobRegister, OutboundSyncStateObserver
{
	...
	@Override
	public @NotNull OutboundSyncJob getJob(@NotNull final OutboundSyncCronJobModel job)
	{
	...
	protected void persistJobState(@NotNull final OutboundSyncCronJobModel job, @NotNull final OutboundSyncState state)
	{
		...
		final OutboundSyncCronJobModel updatedCronjobModel = searchOutboundSyncCronJobModel(job);
	...
	private void waitBeforeUpdateCronjob()
	{
		...
		{
			LOG.debug("Sleep could not be completed", e);
	...
	{
		final Map<String, Object> params = Map.of("pk", job.getPk());
