...
@PreAuthorize("hasRole('TRUSTED_CLIENT') OR @userValidator.isAgreementSpecificationOwner(authentication, #id)")
public @interface AgrAuthorizedAgreementSpecOwnerOrAdmin
{
}
