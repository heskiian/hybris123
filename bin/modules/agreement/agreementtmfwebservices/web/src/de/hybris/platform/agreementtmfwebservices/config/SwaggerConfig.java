 ...
 */
package de.hybris.platform.agreementtmfwebservices.config;
...
import static de.hybris.platform.agreementtmfwebservices.constants.AgreementtmfwebservicesConstants.AUTHORIZATION_URL;
import static de.hybris.platform.agreementtmfwebservices.constants.AgreementtmfwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static de.hybris.platform.agreementtmfwebservices.constants.AgreementtmfwebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static de.hybris.platform.agreementtmfwebservices.constants.AgreementtmfwebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static de.hybris.platform.agreementtmfwebservices.constants.AgreementtmfwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
...
/**
 * Swagger Configuration for agreementtmfwebservices extension
 *
 * @since 2108
 */
public class SwaggerConfig
{
	private static final String PASS_AUTHORIZATION_SCOPE = "agreementtmfwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "agreementtmfwebservices.oauth2.clientCredentials.scope";
	private static final String VERSION_SCOPE = "agreementtmfwebservices.default.version";
