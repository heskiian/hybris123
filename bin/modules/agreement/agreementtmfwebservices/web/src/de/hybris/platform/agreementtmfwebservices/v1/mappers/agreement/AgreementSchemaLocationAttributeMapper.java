...
/**
 * This attribute Mapper class maps data for schema location attribute between {@link AgrAgreementModel} and {@link Agreement}
 *
 * @since 2108
 */
...
{
	public AgreementSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
