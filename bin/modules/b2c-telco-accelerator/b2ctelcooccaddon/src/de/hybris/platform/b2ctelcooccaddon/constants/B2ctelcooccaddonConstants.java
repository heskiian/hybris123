 ...
 */
package de.hybris.platform.b2ctelcooccaddon.constants;

import de.hybris.platform.util.Config;


/**
 * Global class for all b2ctelcooccaddon constants. You can add global constants for your extension into this class.
 */
@SuppressWarnings(
{ "deprecation", "squid:CallToDeprecatedMethod" })
public final class B2ctelcooccaddonConstants extends GeneratedB2ctelcooccaddonConstants
{
	public static final String EXTENSIONNAME = "b2ctelcooccaddon"; //NOSONAR
	...
	public static final String ELIGIBILTY_ROLES = "b2ctelcooccaddon.eligibility.admin.roles";

	public static final String ADMIN_ROLES = "b2ctelcooccaddon.admin.roles";

	private B2ctelcooccaddonConstants()
	{
