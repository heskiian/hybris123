...
/**
 * This attribute Mapper class  maps data for id for attribute between {@link CartData} and {@link ShoppingCart}
 *
 * @since 1907
 */
public class ShoppingCartIdAttributeMapper extends TmaAttributeMapper<CartData, ShoppingCart>
{
	@Override
