 ...
 * @since 2108
 */
public class AttachmentMimeTypeAttributeMapper
		extends AgrAttributeMapper<CatalogUnawareMediaModel, AttachmentRefOrValue>
{
	public AttachmentMimeTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
	...
	public void populateSourceAttributeFromTarget(final AttachmentRefOrValue target, final CatalogUnawareMediaModel source,
			final MappingContext context)
	{
		if (StringUtils.isNotEmpty(target.getMimeType()))
		{
			source.setMime(target.getMimeType());
		}
	}
}
