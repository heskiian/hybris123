 ...
 * @since 2102
 */
public class BundledPsHrefAttributeMapper extends TmaAttributeMapper<TmaProductSpecificationData,
		BundledProductSpecification>
{
	@Override
	public void populateTargetAttributeFromSource(final TmaProductSpecificationData source,
			final BundledProductSpecification target, MappingContext context)
	{
