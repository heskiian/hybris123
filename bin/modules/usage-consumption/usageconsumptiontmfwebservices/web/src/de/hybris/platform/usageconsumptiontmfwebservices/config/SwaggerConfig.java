 ...
 */
package de.hybris.platform.usageconsumptiontmfwebservices.config;
...
import static de.hybris.platform.usageconsumptiontmfwebservices.constants.UsageconsumptiontmfwebservicesConstants.AUTHORIZATION_URL;
import static de.hybris.platform.usageconsumptiontmfwebservices.constants.UsageconsumptiontmfwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static de.hybris.platform.usageconsumptiontmfwebservices.constants.UsageconsumptiontmfwebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static de.hybris.platform.usageconsumptiontmfwebservices.constants.UsageconsumptiontmfwebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static de.hybris.platform.usageconsumptiontmfwebservices.constants.UsageconsumptiontmfwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
...
{
	private static final String PASS_AUTHORIZATION_SCOPE = "usageconsumptiontmfwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "usageconsumptiontmfwebservices.oauth2.clientCredentials.scope";
	private static final String VERSION_SCOPE = "usageconsumptiontmfwebservices.default.version";
