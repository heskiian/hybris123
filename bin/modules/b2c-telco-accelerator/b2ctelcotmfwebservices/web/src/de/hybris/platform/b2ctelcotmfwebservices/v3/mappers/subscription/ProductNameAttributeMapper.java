...
/**
 * This attribute Mapper class maps data for name attribute for Subscription between {@link TmaSubscriptionBaseData} and
 * {@link Product}
 *
 * @since 2102
 */
public class ProductNameAttributeMapper extends TmaAttributeMapper<TmaSubscriptionBaseData, Product>
{
	@Override
			...
			final MappingContext context)
	{
		...
		{
			target.setName(source.getSubscriberIdentity());
		}
	}
}
