...
/**
 * This attribute Mapper class maps data for atType attribute between {@link BaBillingCycleSpecificationModel} and
 * {@link BillingCycleSpecificationRefOrValue}
 *
 * @since 2105
 */
public class BillingCycleSpecAtTypeAttributeMapper
		extends BaAttributeMapper<BaBillingCycleSpecificationModel, BillingCycleSpecificationRefOrValue>
{
	public BillingCycleSpecAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
