 ...
 */
package de.hybris.platform.subscribedproductservices.setup;
 ...
 * @since 2105
 */
@SystemSetup(extension = SubscribedproductservicesConstants.EXTENSIONNAME)
public class SubscribedProductServicesSystemSetup extends AbstractSystemSetup
{
	...
	private void importTestData()
	{
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/apidata/oauthclients.impex",
						SubscribedproductservicesConstants.EXTENSIONNAME), false);
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/apidata/subscribedproducts.impex",
						SubscribedproductservicesConstants.EXTENSIONNAME), false);
