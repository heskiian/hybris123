...
public class TmaAddressController extends BaseController
{
	...
	private static final String ADDRESS_MAPPING = "firstName,lastName,titleCode,phone,cellphone,line1,line2,town,postalCode,region(isocode),district,country(isocode),defaultAddress,installationAddress,building,apartment";
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcoocc.TmaAddressController.createAddress.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcoocc.TmaAddressController.updateAddress.priority")
	...
	public void updateAddress(@ApiParam(value = "Address identifier.", required = true) @PathVariable final String addressId,
			@ApiParam(value = "Address object", required = true) @RequestBody final AddressWsDTO newAddress)
	{
