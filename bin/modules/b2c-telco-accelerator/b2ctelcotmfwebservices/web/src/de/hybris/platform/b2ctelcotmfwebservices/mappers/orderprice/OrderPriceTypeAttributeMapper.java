...
import de.hybris.platform.b2ctelcotmfwebservices.v2.dto.PriceType;
 ...
 * @since 1907
 */
public class OrderPriceTypeAttributeMapper extends TmaAttributeMapper<TmaAbstractOrderChargePriceData, OrderPrice>
{
	@Override
			...
			final MappingContext context)
	{
		...
		{
			target.setPriceType(PriceType.fromValue(source.getTypeOfPrice().getCode()));
		}
	}
}
