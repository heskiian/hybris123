...
/**
 * This attribute Mapper class maps data for atschemaLocation attribute between {@link CatalogUnawareMediaModel} and
 * {@link AttachmentRefOrValue}
 *
 * @since 2108
 */
public class AttachmentRefOrValueSchemaLocationAttributeMapper
		extends BmAttributeMapper<CatalogUnawareMediaModel, AttachmentRefOrValue>
{
	public AttachmentRefOrValueSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.atschemaLocation(BillmanagementtmfwebservicesConstants.BM_API_SCHEMA);
		}
	}
}
