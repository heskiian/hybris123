...
/**
 * This attribute Mapper class maps data for type attribute between {@link BaPaymentInfoModel} and {@link PaymentMethodRef}
 *
 * @since 2111
 */
public class PaymentMethodTypeAttributeMapper extends BaAttributeMapper<BaPaymentInfoModel, PaymentMethodRef>
{
	public PaymentMethodTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
