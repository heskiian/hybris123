...
/**
 * Media specific implementation of the {@link SampleDataImportService}.
 * <ul>
 ...
 * @since 1810
 */
public class MediaSampleDataImportService extends SampleDataImportService
{
	...
	private void importCustomerData()
	{
		getSetupImpexService()
				.importImpexFile(String.format(CUSTOMER_INVENTORY_PATH, MediastoreConstants.EXTENSIONNAME, "/customers.impex"),
						false);
		getSetupImpexService().importImpexFile(
				String.format(CUSTOMER_INVENTORY_PATH, MediastoreConstants.EXTENSIONNAME, "/customerInventory.impex"),
				false);
	}
