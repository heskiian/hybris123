 ...
 * @since 2105
 */
public class SpiEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	private Class<SOURCE> sourceClass;
	private Class<TARGET> targetClass;
	private List<SpiAttributeMapper<SOURCE, TARGET>> attributeMappers;
	...
	@SuppressWarnings("WeakerAccess")
	public List<SpiAttributeMapper<SOURCE, TARGET>> getAttributeMappers()
	{
	...
	@Required
	public void setAttributeMappers(List<SpiAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
