...
/**
 * This attribute Mapper class maps data for at schema location attribute between {@link PrPartyRoleModel} and {@link PartyRole}
 *
 * @since 2108
 */
public class PartyRoleAtSchemaLocationAttributeMapper extends PrAttributeMapper<PrPartyRoleModel, PartyRole>
{
	public PartyRoleAtSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
