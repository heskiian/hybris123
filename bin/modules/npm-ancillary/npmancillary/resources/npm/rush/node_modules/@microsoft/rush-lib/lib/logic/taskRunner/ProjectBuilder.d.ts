...
export declare class ProjectBuilder extends BaseBuilder {
    ...
    tryWriteCacheEntryAsync(terminal: ITerminal, trackedFilePaths: string[] | undefined, repoCommandLineConfiguration: CommandLineConfiguration | undefined): Promise<boolean | undefined>;
