 ...
 * @since 1810
 */
public class TmaSppStockStatusProvider extends ProductStockLevelStatusValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppStockStatusProvider.class);
