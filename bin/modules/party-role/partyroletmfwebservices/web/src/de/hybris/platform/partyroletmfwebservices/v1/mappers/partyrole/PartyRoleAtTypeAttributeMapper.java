...
/**
 * This attribute Mapper class maps data for at type attribute between {@link PrPartyRoleModel} and {@link PartyRole}
 *
 * @since 2108
 */
public class PartyRoleAtTypeAttributeMapper extends PrAttributeMapper<PrPartyRoleModel, PartyRole>
{
	public PartyRoleAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
