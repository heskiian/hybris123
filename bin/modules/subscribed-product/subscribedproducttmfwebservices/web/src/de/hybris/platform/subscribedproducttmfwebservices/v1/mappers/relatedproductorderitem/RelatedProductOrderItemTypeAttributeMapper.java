...
/**
 * This attribute Mapper class maps data for atType attribute between {@link SpiRelatedProductOrderItemModel} and
 * {@link RelatedProductOrderItem}
 *
 * @since 2105
 */
public class RelatedProductOrderItemTypeAttributeMapper
		extends SpiAttributeMapper<SpiRelatedProductOrderItemModel, RelatedProductOrderItem>
{
	public RelatedProductOrderItemTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final RelatedProductOrderItem target, MappingContext context)
	{
		...
		{
			target.setAtreferredType(SubscribedproducttmfwebservicesConstants.SPI_RELATED_PRODUCT_ORDER_ITEM_TYPE);
		}
	}
}
