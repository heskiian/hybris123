...
/**
 * This attribute Mapper class maps data for at referred type attribute between {@link PrPartyModel} and {@link RelatedParty}
 *
 * @since 2108
 */
public class RelatedPartyAtReferredTypeAttributeMapper extends PrAttributeMapper<PrPartyModel, RelatedParty>
{
			...
			final MappingContext context)
	{
		...
		target.setAtreferredType(PartyroletmfwebservicesConstants.PARTY_DEFAULT_REFERRED_TYPE);
	}
}
