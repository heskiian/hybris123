...
/**
 * This attribute Mapper class maps data for id attribute between {@link UcPartyRoleModel} and {@link RelatedParty}
 *
 * @since 2105
 */
public class RelatedPartyIdAttributeMapper extends UcAttributeMapper<UcPartyRoleModel, RelatedParty>
{
	...
	{
		if (StringUtils.isNotEmpty(source.getParty().getId()))
		{
