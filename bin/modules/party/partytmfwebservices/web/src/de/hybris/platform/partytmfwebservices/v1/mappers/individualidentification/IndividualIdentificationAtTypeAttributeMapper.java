...
/**
 * This attribute Mapper class maps data for at type attribute between {@link PmIdentificationModel} and {@link IndividualIdentification}
 *
 * @since 2108
 */
public class IndividualIdentificationAtTypeAttributeMapper
		extends PmAttributeMapper<PmIdentificationModel, IndividualIdentification>
{
	public IndividualIdentificationAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
