...
/**
 * This attribute Mapper class maps data for atBaseType attribute between {@link UcConsumptionSummaryModel} and
 * {@link ConsumptionSummary}
 *
 * @since 2108
 */
public class NetworkProductAtBaseTypeAttributeMapper extends UcAttributeMapper<UcNetworkProductModel, NetworkProduct>
{
	public NetworkProductAtBaseTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.setAtbaseType(UsageconsumptiontmfwebservicesConstants.UC_NETWORK_PRODUCT_BASE_TYPE);
		}
	}
}
