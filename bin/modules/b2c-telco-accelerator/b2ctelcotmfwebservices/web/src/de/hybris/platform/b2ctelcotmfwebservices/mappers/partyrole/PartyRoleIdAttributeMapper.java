...
/**
 * This attribute Mapper class maps data for id attribute between {@link PrincipalData} and {@link PartyRole}
 *
 * @since 1907
 */
public class PartyRoleIdAttributeMapper extends TmaAttributeMapper<PrincipalData, PartyRole>
{
	@Override
