...
/**
 * Default implementation of {@link AgrPaginationService}.
 *
 * @since 2108
 */
public class DefaultAgrPaginationService implements AgrPaginationService
{
	...
	{
		return Integer.valueOf(Config.getParameter(AgreementservicesConstants.PAGINATION_DEFAULT_LIMIT));
	}
