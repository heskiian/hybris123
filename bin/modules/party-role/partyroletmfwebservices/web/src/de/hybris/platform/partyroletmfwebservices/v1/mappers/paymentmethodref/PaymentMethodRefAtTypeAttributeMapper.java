...
/**
 * This attribute Mapper class maps data for at type attribute between {@link PaymentInfoModel} and {@link PaymentMethodRef}
 *
 * @since 2108
 */
public class PaymentMethodRefAtTypeAttributeMapper extends PrAttributeMapper<PaymentInfoModel, PaymentMethodRef>
{
	public PaymentMethodRefAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
