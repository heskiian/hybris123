...
/**
 * This attribute Mapper class maps data for atReferredType attribute between {@link BmBillingAccountModel} and
 * {@link BillingAccountRef}
 *
 * @since 2108
 */
public class BillingAccountRefReferredTypeAttributeMapper extends BmAttributeMapper<BmBillingAccountModel, BillingAccountRef>
{
	public BillingAccountRefReferredTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.setAtreferredType(Config.getParameter(BillmanagementtmfwebservicesConstants.BILLING_ACCOUNT_DEFAULT_REFERRED));
		}
	}
}
