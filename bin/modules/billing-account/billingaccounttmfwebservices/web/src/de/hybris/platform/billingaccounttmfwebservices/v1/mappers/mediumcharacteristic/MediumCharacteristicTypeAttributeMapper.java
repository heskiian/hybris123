...
/**
 * This attribute Mapper class maps data for type attribute between {@link BaMediumCharacteristicModel} and {@link MediumCharacteristic}
 *
 * @since 2105
 */
public class MediumCharacteristicTypeAttributeMapper
		extends BaAttributeMapper<BaMediumCharacteristicModel, MediumCharacteristic>
{
	public MediumCharacteristicTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
