...
/**
 * This attribute Mapper class maps data for id attribute between {@link CCPaymentInfoData} and {@link PaymentRef}
 *
 * @since 2003
 */
public class PaymentRefIdAttributeMapper extends TmaAttributeMapper<CCPaymentInfoData, PaymentRef>
{
	@Override
