...
/**
 * This attribute Mapper class maps data for href attribute between {@link TmaPricingLogicAlgorithmData} and {@link PricingLogicAlgorithm}
 *
 * @since 2102
 */
public class PlaHrefAttributeMapper extends TmaAttributeMapper<TmaPricingLogicAlgorithmData, PricingLogicAlgorithm>
{
	@Override
			...
			final MappingContext context)
	{
		...
		{
			target.setHref(B2ctelcotmfwebservicesConstants.PRICING_LOGIC_ALGORITHM_API_URL + source.getId());
		}
	}
}
