...
package de.hybris.platform.billmanagementtmfwebservices.v1.mappers;
 ...
 * @since 2108
 */
public class BmEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	/**
	 * Source class
	 */
	 ...
	 */
	private List<BmAttributeMapper<SOURCE, TARGET>> attributeMappers;

	public BmEntityMapper(final Class<SOURCE> sourceClass, final Class<TARGET> targetClass,
			final List<BmAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
