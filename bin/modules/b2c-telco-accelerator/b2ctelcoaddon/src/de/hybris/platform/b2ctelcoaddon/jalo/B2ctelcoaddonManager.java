 ...
 */
package de.hybris.platform.b2ctelcoaddon.jalo;
...
/**
 * This is the extension manager of the B2ctelcoaddon extension.
 */
public class B2ctelcoaddonManager extends GeneratedB2ctelcoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcoaddonManager.class.getName());
	 ...
	 */
	public B2ctelcoaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcoaddonManager called.");
		}
	}
	 ...
	 */
	public static B2ctelcoaddonManager getInstance()
	{
		return (B2ctelcoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ctelcoaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
