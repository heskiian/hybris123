...
/**
 * This attribute Mapper class maps data for name attribute between {@link UcPartyRoleModel} and {@link RelatedParty}
 *
 * @since 2105
 */
public class RelatedPartyNameAttributeMapper extends UcAttributeMapper<UcPartyRoleModel, RelatedParty>
{
	...
	{
		if (StringUtils.isNotEmpty(source.getParty().getName()))
		{
