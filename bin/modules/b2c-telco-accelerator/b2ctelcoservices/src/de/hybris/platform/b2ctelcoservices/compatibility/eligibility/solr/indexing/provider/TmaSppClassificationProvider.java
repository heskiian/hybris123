 ...
 * @since 1810
 */
public class TmaSppClassificationProvider extends CommerceClassificationPropertyValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppClassificationProvider.class);
