...
/**
 * This attribute Mapper class maps data for at referred type attribute between {@link PmPartyModel} and {@link RelatedParty}
 *
 * @since 2108
 */
public class RelatedPartyAtReferredTypeAttributeMapper extends PmAttributeMapper<PmPartyModel, RelatedParty>
{
			...
			final MappingContext context)
	{
		...
		target.setAtreferredType(PartytmfwebservicesConstants.PARTY_DEFAULT_REFERRED_TYPE);
	}
}
