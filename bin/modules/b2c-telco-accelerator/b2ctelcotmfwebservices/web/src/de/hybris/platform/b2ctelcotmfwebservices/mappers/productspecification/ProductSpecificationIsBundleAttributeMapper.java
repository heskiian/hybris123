...
/**
 * This attribute Mapper class maps data for isBundle attribute between {@link TmaProductSpecificationData} and
 * {@link ProductSpecification}
 *
 * @since 2102
 */
public class ProductSpecificationIsBundleAttributeMapper
		extends TmaAttributeMapper<TmaProductSpecificationData, ProductSpecification>
{
	...
	{
		target.setIsBundle(source instanceof TmaCompositeProductSpecificationData && CollectionUtils
				.isNotEmpty(((TmaCompositeProductSpecificationData) source).getChildren()));
	}
}
