 ...
 * @since 1911
 */
public class TmaCartCostTaxPriceAttributeMapper extends TmaAttributeMapper<TmaAbstractOrderChargePriceData, CartCostWsDTO>
{
			...
			final MappingContext context)
	{
		...
		if (!ObjectUtils.isEmpty(source.getTaxIncludedAmount()))
		{
			final MoneyWsDTO money = getMapperFacade().map(source.getTaxIncludedAmount(), MoneyWsDTO.class, context);
