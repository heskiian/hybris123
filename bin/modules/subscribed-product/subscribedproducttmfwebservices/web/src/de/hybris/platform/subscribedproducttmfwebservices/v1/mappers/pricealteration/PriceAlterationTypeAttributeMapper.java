...
/**
 * This attribute Mapper class maps data for atType attribute between {@link SpiPriceAlterationModel} and {@link PriceAlteration}
 *
 * @since 2105
 */
public class PriceAlterationTypeAttributeMapper extends SpiAttributeMapper<SpiPriceAlterationModel, PriceAlteration>
{
	public PriceAlterationTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.setAttype(SubscribedproducttmfwebservicesConstants.SPI_PRICE_ALTERATION_TYPE);
		}
	}
}
