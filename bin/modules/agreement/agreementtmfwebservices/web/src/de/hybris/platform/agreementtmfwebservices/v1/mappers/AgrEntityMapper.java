...
package de.hybris.platform.agreementtmfwebservices.v1.mappers;
 ...
 * @since 2108
 */
public class AgrEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	/**
	 * Source class
	 */
	 ...
	 */
	private List<AgrAttributeMapper<SOURCE, TARGET>> attributeMappers;

	public AgrEntityMapper(final Class<SOURCE> sourceClass, final Class<TARGET> targetClass,
			final List<AgrAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
	...
	@SuppressWarnings("WeakerAccess")
	protected List<AgrAttributeMapper<SOURCE, TARGET>> getAttributeMappers()
	{
