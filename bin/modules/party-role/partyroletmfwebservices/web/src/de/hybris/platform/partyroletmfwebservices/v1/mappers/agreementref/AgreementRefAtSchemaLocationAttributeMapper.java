...
/**
 * This attribute Mapper class maps data for at schema location attribute between {@link PrBusinessInteractionModel} and {@link AgreementRef}
 *
 * @since 2108
 */
public class AgreementRefAtSchemaLocationAttributeMapper extends PrAttributeMapper<PrBusinessInteractionModel, AgreementRef>
{
	public AgreementRefAtSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
