...
package de.hybris.platform.subscribedproducttmfwebservices.context.impl;
 ...
 * @since 2111
 */
public class SpiDefaultContextInformationLoader implements SpiContextInformationLoader
{
	private static final Logger LOG = Logger.getLogger(SpiDefaultContextInformationLoader.class);

	private CommonI18NService commonI18NService;
	private CommerceCommonI18NService commerceCommonI18NService;


	public SpiDefaultContextInformationLoader(final CommonI18NService commonI18NService,
	...
	public LanguageModel setLanguageFromRequest(final HttpServletRequest request)
	{
		...
		final String acceptLanguageValue = request.getHeader(SubscribedproducttmfwebservicesConstants.HTTP_REQUEST_HEADER_LANGUAGE);
