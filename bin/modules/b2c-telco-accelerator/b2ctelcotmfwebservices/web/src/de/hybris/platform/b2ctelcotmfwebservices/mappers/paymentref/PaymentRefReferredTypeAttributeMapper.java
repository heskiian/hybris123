...
/**
 * This attribute Mapper class maps data for atrefferedType attribute between {@link CCPaymentInfoData} and {@link PaymentRef}
 *
 * @since 2003
 */
public class PaymentRefReferredTypeAttributeMapper extends TmaAttributeMapper<CCPaymentInfoData, PaymentRef>
{
	@Override
