...
public class TmaSppIsBundledProvider extends TmaAbstractSppProvider
{
	 ...
	 * @return A list of fieldValues which contain the model's isBundled value.
	 */
	@Override
	protected Collection<FieldValue> getValues(IndexedProperty indexedProperty, Object model)
	{
		...
		{
			boolean isBundled = model instanceof TmaBundledProductOfferingModel;
			addFieldValues(fieldValues, indexedProperty, null, isBundled);
		}
