...
/**
 * This attribute Mapper class maps data for href attribute between {@link AgrProductOfferingModel} and {@link ProductOfferingRef}
 *
 * @since 2108
 */
		...
		extends AgrAttributeMapper<AgrProductOfferingModel, ProductOfferingRef>
{
			...
			final MappingContext context)
	{
		...
		{
			target.setHref(AgreementtmfwebservicesConstants.PRODUCT_OFFERING_API_URL + source.getId());
		}
	}
}
