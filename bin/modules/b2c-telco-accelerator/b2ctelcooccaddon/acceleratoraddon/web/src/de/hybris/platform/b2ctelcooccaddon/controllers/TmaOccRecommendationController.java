...
import de.hybris.platform.b2ctelcocommercewebservicescommons.validator.TmaProcessTypeValidator;
import de.hybris.platform.b2ctelcocommercewebservicescommons.validator.TmaSubscriptionBaseValidator;
...
public class TmaOccRecommendationController extends BaseController
{
	...
	{
		selectedSubscriptions.forEach(subscriptionBaseData -> {
			validate(subscriptionBaseData, "TmaSubscriptionBase", tmaSubscriptionBaseValidator);
		});
	}
