...
/**
 * This attribute Mapper class maps data for at referred type attribute between {@link PrOrganizationModel} and {@link RelatedParty}
 *
 * @since 2108
 */
public class RelatedPartyAtReferredTypeAttributeMapper extends PrAttributeMapper<PrOrganizationModel, RelatedParty>
{
			...
			final MappingContext context)
	{
		...
		target.setAtreferredType(PartyroletmfwebservicesConstants.ORGANIZATION_DEFAULT_REFERRED_TYPE);
	}
}
