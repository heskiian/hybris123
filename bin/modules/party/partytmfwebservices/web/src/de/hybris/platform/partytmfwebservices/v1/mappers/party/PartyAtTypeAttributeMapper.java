...
/**
 * This attribute Mapper class maps data for at type attribute between {@link PmPartyModel} and {@link Party}
 *
 * @since 2108
 */
public class PartyAtTypeAttributeMapper extends PmAttributeMapper<PmPartyModel, Party>
{
	public PartyAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
