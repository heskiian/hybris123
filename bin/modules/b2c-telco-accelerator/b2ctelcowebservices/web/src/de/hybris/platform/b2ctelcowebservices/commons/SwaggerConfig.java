 ...
 */
package de.hybris.platform.b2ctelcowebservices.commons;
...
import static de.hybris.platform.b2ctelcowebservices.constants.B2ctelcowebservicesConstants.*;
...
{
	private static final String PASS_AUTHORIZATION_SCOPE = "b2ctelcowebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "b2ctelcowebservices.oauth2.clientCredentials.scope";
	private static final String VERSION_SCOPE = "b2ctelcowebservices.default.version";
	...
	protected OAuth clientCredentialFlow()
	{
		final AuthorizationScope authorizationScope = new AuthorizationScope(
				getPropertyValue(CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE),
				StringUtils.EMPTY);
