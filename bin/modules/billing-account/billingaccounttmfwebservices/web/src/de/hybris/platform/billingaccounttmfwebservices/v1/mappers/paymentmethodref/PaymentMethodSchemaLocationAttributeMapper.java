...
/**
 * This attribute Mapper class maps data for schema location attribute between {@link BaPaymentInfoModel} and {@link PaymentMethodRef}
 *
 * @since 2111
 */
public class PaymentMethodSchemaLocationAttributeMapper extends BaAttributeMapper<BaPaymentInfoModel, PaymentMethodRef>
{
	public PaymentMethodSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
