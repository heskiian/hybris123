 ...
 */
package de.hybris.platform.partytmfwebservices.config;

import static de.hybris.platform.partytmfwebservices.constants.PartytmfwebservicesConstants.AUTHORIZATION_URL;
import static de.hybris.platform.partytmfwebservices.constants.PartytmfwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static de.hybris.platform.partytmfwebservices.constants.PartytmfwebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static de.hybris.platform.partytmfwebservices.constants.PartytmfwebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static de.hybris.platform.partytmfwebservices.constants.PartytmfwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
...
/**
 * Swagger Configuration for partytmfwebservices extension
 *
 * @since 2108
 */
public class SwaggerConfig
{
	private static final String PASS_AUTHORIZATION_SCOPE = "partytmfwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "partytmfwebservices.oauth2.clientCredentials.scope";
	private static final String VERSION_SCOPE = "partytmfwebservices.default.version";
