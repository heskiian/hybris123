...
import de.hybris.platform.b2ctelcoservices.search.solrfacetsearch.provider.impl.TmaProductOfferingGroupValueProvider;
 ...
 * @since 1810
 */
public class TmaSppPoGroupProvider extends TmaProductOfferingGroupValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppPoGroupProvider.class);
