...
/**
 * This attribute Mapper class maps data for href attribute between {@link PaymentInfoModel} and {@link PaymentMethodRef}
 *
 * @since 2108
 */
public class PaymentMethodRefHrefAttributeMapper extends PrAttributeMapper<PaymentInfoModel, PaymentMethodRef>
{
	public PaymentMethodRefHrefAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		target.setHref(PartyroletmfwebservicesConstants.PAYMENT_METHOD_API_URL + source.getCode());
	}
}
