...
public class GenericConditionQueryBuilderTest
{
	...
	@Test
	public void shouldReturnOperatorsIsNullAndEmptyWhenSearchWithIsEmptyForHandleUnaryOperator()
	{
		// when
	...
	@Test
	public void shouldReturnOperatorsIsNotNullAndNotEmptyWhenSearchWithIsNotEmptyForHandleUnaryOperator()
	{
		// when
	...
	@Test
	public void shouldReturnOperatorsIsNullAndEmptyWhenSearchWithIsEmpty()
	{
		// given
	...
	@Test
	public void shouldReturnOperatorsIsNotNullAndNotEmptyWhenSearchWithIsNotEmpty()
	{
		// given
		final SearchAttributeDescriptor attributeDescriptor = mock(SearchAttributeDescriptor.class);
		when(attributeDescriptor.getAttributeName()).thenReturn(DATE_TYPE_ATTRIBUTE);
