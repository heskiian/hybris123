...
package de.hybris.platform.partyroleservices.setup;

import de.hybris.platform.core.Registry;
import de.hybris.platform.core.initialization.SystemSetup;
import de.hybris.platform.core.initialization.SystemSetupContext;
import de.hybris.platform.core.initialization.SystemSetupParameter;
import de.hybris.platform.partyroleservices.constants.PartyroleservicesConstants;
 ...
 * @since 2108
 */
@SystemSetup(extension = PartyroleservicesConstants.EXTENSIONNAME)
public class PartyRoleSystemSetup extends AbstractSystemSetup
{
	...
	private void importTestData()
	{
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/apidata/oauthclients.impex",
						PartyroleservicesConstants.EXTENSIONNAME), false);
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/apidata/partyroles.impex",
						PartyroleservicesConstants.EXTENSIONNAME), false);
	}
