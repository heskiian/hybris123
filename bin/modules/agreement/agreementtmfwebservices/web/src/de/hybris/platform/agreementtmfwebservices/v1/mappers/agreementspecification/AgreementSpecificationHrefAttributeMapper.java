...
/**
 * This attribute Mapper class maps data for href attribute between {@link AgrAgreementSpecificationModel} and
 * {@link AgreementSpecification}
 *
 * @since 2108
 */
public class AgreementSpecificationHrefAttributeMapper
		extends AgrAttributeMapper<AgrAgreementSpecificationModel, AgreementSpecification>
{
	public AgreementSpecificationHrefAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
