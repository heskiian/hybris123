...
/**
 * This attribute Mapper class maps data for atSchemaLocation attribute between {@link SpiAgreementItemModel} and
 * {@link AgreementItemRef}
 *
 * @since 2105
 */
public class AgreementItemRefSchemaLocationAttributeMapper extends SpiAttributeMapper<SpiAgreementItemModel, AgreementItemRef>
{
	public AgreementItemRefSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
