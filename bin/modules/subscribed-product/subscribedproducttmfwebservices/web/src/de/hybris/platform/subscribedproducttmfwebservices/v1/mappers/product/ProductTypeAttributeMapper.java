...
/**
 * This attribute Mapper class maps data for atType attribute between {@link SpiProductModel} and {@link Product}
 *
 * @since 2105
 */
public class ProductTypeAttributeMapper extends SpiAttributeMapper<SpiProductModel, Product>
{
	public ProductTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
	...
	public void populateTargetAttributeFromSource(final SpiProductModel source, final Product target, final MappingContext context)
	{
		...
		{
			target.setAttype(SubscribedproducttmfwebservicesConstants.SPI_PRODUCT_TYPE);
		}
	}
}
