 ...
 * @since 2111
 */
public class AgrCharacteristicPrepareInterceptor implements PrepareInterceptor<AgrAgreementSpecCharacteristicValueModel>
{
	private KeyGenerator keyGenerator;

	public AgrCharacteristicPrepareInterceptor(final KeyGenerator keyGenerator)
	{
		this.keyGenerator = keyGenerator;
	}

	@Override
	public void onPrepare(final AgrAgreementSpecCharacteristicValueModel characteristicModel, final InterceptorContext ctx)
	{
