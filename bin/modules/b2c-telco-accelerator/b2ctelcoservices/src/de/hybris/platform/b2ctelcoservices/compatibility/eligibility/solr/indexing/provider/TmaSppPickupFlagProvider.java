 ...
 * @since 1810
 */
public class TmaSppPickupFlagProvider extends ProductPickupAvailabilityValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppPickupFlagProvider.class);
