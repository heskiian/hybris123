...
package de.hybris.platform.usageconsumptiontmfwebservices.v1.mappers;
 ...
 * @since 8
 */
public class UcEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	private Class<SOURCE> sourceClass;
	private Class<TARGET> targetClass;
	private List<UcAttributeMapper<SOURCE, TARGET>> attributeMappers;
	...
	@SuppressWarnings("WeakerAccess")
	public List<UcAttributeMapper<SOURCE, TARGET>> getAttributeMappers()
	{
	...
	@Required
	public void setAttributeMappers(List<UcAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
