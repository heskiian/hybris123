 ...
 * @since 2108
 */
public class PaymentMethodRefIdAttributeMapper extends PrAttributeMapper<PaymentInfoModel, PaymentMethodRef>
{
	public PaymentMethodRefIdAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
