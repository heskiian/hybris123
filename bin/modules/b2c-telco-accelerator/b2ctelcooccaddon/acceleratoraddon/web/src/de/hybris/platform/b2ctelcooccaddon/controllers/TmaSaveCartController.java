...
public class TmaSaveCartController extends BaseController
{
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaCartsController.cloneCart.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaSaveCartController.doUpdateSavedCart.priority")
	@ResponseBody
