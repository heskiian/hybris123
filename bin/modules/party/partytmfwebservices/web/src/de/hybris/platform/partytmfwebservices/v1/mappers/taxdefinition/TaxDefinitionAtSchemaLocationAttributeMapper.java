...
/**
 * This attribute Mapper class maps data for at schema location attribute between {@link PmTaxDefinitionModel} and {@link TaxDefinition}
 *
 * @since 2108
 */
public class TaxDefinitionAtSchemaLocationAttributeMapper extends PmAttributeMapper<PmTaxDefinitionModel, TaxDefinition>
{
	public TaxDefinitionAtSchemaLocationAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
