 ...
 * @since 2007
 */
public class GeographicAddressStreetNumberAttributeMapper extends TmaAttributeMapper<AddressData, GeographicAddress>
{
	@Override
	public void populateTargetAttributeFromSource(AddressData source, GeographicAddress target, MappingContext context)
	{
		if (StringUtils.isNotEmpty(source.getLine2()))
		{
			target.setStreetNr(source.getLine2());
		}
	}
	...
	{
		if (StringUtils.isNotEmpty(target.getStreetNr()))
		{
			source.setLine2(target.getStreetNr());
		}
	}
}
