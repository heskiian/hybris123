 ...
 */
package de.hybris.platform.partyroletmfwebservices.config;
...
import static de.hybris.platform.partyroletmfwebservices.constants.PartyroletmfwebservicesConstants.AUTHORIZATION_URL;
import static de.hybris.platform.partyroletmfwebservices.constants.PartyroletmfwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static de.hybris.platform.partyroletmfwebservices.constants.PartyroletmfwebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static de.hybris.platform.partyroletmfwebservices.constants.PartyroletmfwebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static de.hybris.platform.partyroletmfwebservices.constants.PartyroletmfwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
 ...
 * @since 2108
 */
public class PrSwaggerConfig
{
	private static final String PASS_AUTHORIZATION_SCOPE = "partyroletmfwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "partyroletmfwebservices.oauth2.clientCredentials.scope";
	private static final String VERSION_SCOPE = "partyroletmfwebservices.default.version";
