...
/**
 * This Mapper class maps data in between {@link TmaSubscriptionBaseData} and {@link TmaSubscriptionBaseDetailRefWsDto}.
 *
 * @since 1810
 */
public class TmaSubscriptionBaseDetailRefWsDtoFromBaseDataMapper
		extends TmaTmfAbstractRelatedPartyDataMapper<TmaSubscriptionBaseData, TmaSubscriptionBaseDetailRefWsDto>
{
	...
	@Override
	public void mapAtoB(final TmaSubscriptionBaseData a, final TmaSubscriptionBaseDetailRefWsDto b, final MappingContext context)
	{
	...
	protected void mapFieldsAtoB(final TmaSubscriptionBaseData a, final TmaSubscriptionBaseDetailRefWsDto b,
	...
	protected void mapProductRefAtoB(final TmaSubscriptionBaseData a, final TmaSubscriptionBaseDetailRefWsDto b,
			final MappingContext context)
	{
	...
	protected void mapRelatedPartyRefAtoB(final TmaSubscriptionBaseData a, final TmaSubscriptionBaseDetailRefWsDto b,
			final MappingContext context)
	{
	...
	@Override
	public void mapBtoA(final TmaSubscriptionBaseDetailRefWsDto b, final TmaSubscriptionBaseData a, final MappingContext context)
	{
