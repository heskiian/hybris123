 ...
 * @since 1911
 */
public class TmaCartEntriesProcessTypeAttributeMapper extends TmaAttributeMapper<OrderEntryData, OrderEntryWsDTO>
{
	@Override
			...
			final MappingContext context)
	{
		...
		if (source.getProcessType() != null)
		{
			...
			processTypeDto.setId(source.getProcessType().getCode());
			target.setProcessType(processTypeDto);
		}
	}
}
