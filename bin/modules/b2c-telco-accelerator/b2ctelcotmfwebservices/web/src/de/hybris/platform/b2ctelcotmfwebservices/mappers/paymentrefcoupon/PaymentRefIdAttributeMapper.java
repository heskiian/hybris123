...
/**
 * This attribute Mapper class maps data for id attribute between {@link CouponData} and {@link PaymentRef}
 *
 * @since 2003
 */
public class PaymentRefIdAttributeMapper extends TmaAttributeMapper<CouponData, PaymentRef>
{
	@Override
