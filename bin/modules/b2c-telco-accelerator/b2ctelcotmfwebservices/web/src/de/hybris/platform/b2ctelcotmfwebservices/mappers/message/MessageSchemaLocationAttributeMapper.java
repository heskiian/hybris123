...
/**
 * This attribute Mapper class maps SchemaLocation between {@link String} and {@link Message}
 *
 * @since 1907
 */
public class MessageSchemaLocationAttributeMapper extends TmaAttributeMapper<String, Message>
{
	@Override
