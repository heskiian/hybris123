...
/**
 * This attribute Mapper class maps data for role attribute between {@link PmBusinessInteractionRoleModel} and {@link RelatedParty}
 *
 * @since 2108
 */
public class RelatedPartyRoleAttributeMapper extends PmAttributeMapper<PmBusinessInteractionRoleModel, RelatedParty>
{
	...
	{
		if (StringUtils.isEmpty(source.getInteractionType()))
		{
			return;
		}

		target.setRole(source.getInteractionType());
	}
}
