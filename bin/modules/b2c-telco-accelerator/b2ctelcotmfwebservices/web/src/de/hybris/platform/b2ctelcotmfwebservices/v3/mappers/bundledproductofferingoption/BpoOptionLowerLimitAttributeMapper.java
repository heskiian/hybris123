...
/**
 * This attribute Mapper class maps data for number rel offer lower limit attribute between {@link TmaBundledProdOfferOptionData} and {@link BundledProductOfferingOption}
 *
 * @since 2011
 */
public class BpoOptionLowerLimitAttributeMapper
		extends TmaAttributeMapper<TmaBundledProdOfferOptionData, BundledProductOfferingOption>
{
	...
	{
		if (source.getLowerLimit() != null)
		{
			target.setNumberRelOfferLowerLimit(source.getLowerLimit());
		}
	}
}
