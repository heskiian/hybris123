 ...
 */
package de.hybris.platform.b2ctelcooccaddon.filters;
...
public class TmaEligibilityContextFilter extends OncePerRequestFilter
{
	...
	{
		final List<String> eligibilityAdminRoles = Arrays.asList(getConfigurationService().getConfiguration().getString(B2ctelcooccaddonConstants.ELIGIBILTY_ROLES).split(REGEX));
