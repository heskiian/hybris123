...
import de.hybris.platform.b2ctelcoservices.search.solrfacetsearch.provider.impl.TmaSpoHasParentBposValueProvider;
 ...
 * @since 1810
 */
public class TmaSppBpoParentProvider extends TmaSpoHasParentBposValueProvider
{
	private static final Logger LOGGER = LoggerFactory.getLogger(TmaSppBpoParentProvider.class);
