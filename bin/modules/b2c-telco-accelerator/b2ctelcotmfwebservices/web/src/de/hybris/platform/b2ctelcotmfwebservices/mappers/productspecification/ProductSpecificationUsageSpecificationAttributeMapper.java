...
/**
 * This attribute Mapper class maps data for usageSpecification attribute between {@link TmaProductSpecificationData} and
 * {@link ProductSpecification}
 *
 * @since 2102
 */
public class ProductSpecificationUsageSpecificationAttributeMapper
		extends TmaAttributeMapper<TmaProductSpecificationData, ProductSpecification>
{
	private MapperFacade mapperFacade;

	public ProductSpecificationUsageSpecificationAttributeMapper(final MapperFacade mapperFacade)
	{
	...
	{
		if (source.getUsageSpecification() == null)
		{
			return;
		}

		target.setUsageSpecification(getMapperFacade().map(source.getUsageSpecification(), UsageSpecificationRef.class, context));
	}
