...
public class TmaProductsController extends BaseController
{
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaProductsController.getProductByCode.priority")
	...
	{
		final List<String> eligibilityAdminRoles = Arrays.asList(configurationService.getConfiguration().getString(B2ctelcooccaddonConstants.ELIGIBILTY_ROLES).split(REGEX));
