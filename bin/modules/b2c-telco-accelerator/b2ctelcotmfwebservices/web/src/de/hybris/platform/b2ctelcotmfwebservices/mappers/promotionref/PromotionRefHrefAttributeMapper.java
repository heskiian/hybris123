...
/**
 * This attribute Mapper class maps data for href attribute between {@link PromotionResultData} and{@link PromotionRef}
 *
 * @since 1911
 */
public class PromotionRefHrefAttributeMapper extends TmaAttributeMapper<PromotionResultData, PromotionRef>
{
	@Override
	public void populateTargetAttributeFromSource(PromotionResultData source, PromotionRef target, MappingContext context)
	{
		...
		{
			target.setHref(B2ctelcotmfwebservicesConstants.PROMOTION_REF_API_URL + source.getPromotionData().getCode());
		}
	}
}
