...
/**
 * Validator for {@link AgreementSpecification} related events.
 *
 * @since 2111
 */
public abstract class AgrAgreementSpecBaseEventValidator implements Validator
{
	private static final String EVENT_ID = "eventId";

	protected static final String AGREEMENT_SPEC_ID = "event.agreementSpecification.id";
	...
	public void baseValidate(final Object o, final Errors errors)
	{
		...
		ValidationUtils.rejectIfEmpty(errors, AGREEMENT_SPEC_ID, FIELD_REQUIRED_MESSAGE);
	}
