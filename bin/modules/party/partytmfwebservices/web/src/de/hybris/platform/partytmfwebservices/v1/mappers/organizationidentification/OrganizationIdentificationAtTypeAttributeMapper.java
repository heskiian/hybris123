...
/**
 * This attribute Mapper class maps data for at type attribute between {@link PmIdentificationModel} and {@link OrganizationIdentification}
 *
 * @since 2108
 */
public class OrganizationIdentificationAtTypeAttributeMapper
		extends PmAttributeMapper<PmIdentificationModel, OrganizationIdentification>
{
	public OrganizationIdentificationAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
