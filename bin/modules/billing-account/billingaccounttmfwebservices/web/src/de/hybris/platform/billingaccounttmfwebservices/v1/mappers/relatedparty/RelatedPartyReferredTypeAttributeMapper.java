...
/**
 * This attribute Mapper class maps data for type attribute between {@link BaPartyRoleModel} and {@link RelatedParty}
 *
 * @since 2105
 */
public class RelatedPartyReferredTypeAttributeMapper extends BaAttributeMapper<BaPartyRoleModel, RelatedParty>
{
			...
			final MappingContext context)
	{
		...
		{
			target.setAtreferredType(Config.getParameter(BillingaccounttmfwebservicesConstants.INDIVIDUAL_RELATED_PARTY_REFERRED));
		}
		else
		{
			target.setAtreferredType(Config.getParameter(BillingaccounttmfwebservicesConstants.ORGANIZATION_RELATED_PARTY_REFERRED));
		}
	}
}
