...
public class TmaAddressController extends BaseController
{
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaAddressController.createAddress.priority")
	@ResponseBody
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaAddressController.updateAddress.priority")
