...
/**
 * This attribute Mapper class maps data for at schema location attribute between {@link PmTaxExemptionCertificateModel} and {@link TaxExemptionCertificate}
 *
 * @since 2108
 */
public class TaxExemptionCertificateAtSchemaLocationAttributeMapper
		extends PmAttributeMapper<PmTaxExemptionCertificateModel, TaxExemptionCertificate>
{
	public TaxExemptionCertificateAtSchemaLocationAttributeMapper(final String sourceAttributeName,
