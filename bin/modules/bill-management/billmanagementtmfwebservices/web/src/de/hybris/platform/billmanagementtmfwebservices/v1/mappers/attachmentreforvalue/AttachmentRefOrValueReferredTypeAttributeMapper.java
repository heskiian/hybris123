...
/**
 * This attribute Mapper class maps data for atreferredType attribute between {@link CatalogUnawareMediaModel} and
 * {@link AttachmentRefOrValue}
 *
 * @since 2108
 */
public class AttachmentRefOrValueReferredTypeAttributeMapper
		extends BmAttributeMapper<CatalogUnawareMediaModel, AttachmentRefOrValue>
{
	public AttachmentRefOrValueReferredTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.atreferredType(BillmanagementtmfwebservicesConstants.BM_ATTACHMENT_REFERRED);
		}
	}
}
