...
@PreAuthorize("@userValidator.isNotAnonymous(#productOrder) AND (hasRole('TRUSTED_CLIENT') OR @userValidator.isRelatedPartyAuthorizedToPlaceOrder(authentication, #productOrder))")
