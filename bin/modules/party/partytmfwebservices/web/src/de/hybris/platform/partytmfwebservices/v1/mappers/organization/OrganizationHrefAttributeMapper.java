...
/**
 * This attribute Mapper class maps data for href attribute between {@link PmOrganizationModel} and {@link Organization}
 *
 * @since 2108
 */
public class OrganizationHrefAttributeMapper extends PmAttributeMapper<PmOrganizationModel, Organization>
{
	public OrganizationHrefAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
