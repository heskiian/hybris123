...
/**
 * This attribute Mapper class maps data for isShippingtAddress attribute between {@link AddressData} and
 * {@link GeographicAddress}
 *
 * @since 1907
 */
public class GeographicAddressIsShippingAddressAttributeMapper extends TmaAttributeMapper<AddressData, GeographicAddress>
{
	@Override
	public void populateTargetAttributeFromSource(AddressData source, GeographicAddress target, MappingContext context)
	{
		target.isShippingAddress(source.isShippingAddress());
	}
	...
	{
		if (target.isIsShippingAddress() != null)
		{
			source.setShippingAddress(target.isIsShippingAddress());
		}
	}
}
