...
/**
 * This attribute Mapper class maps data for name attribute between {@link OrderEntryData} and {@link Product}
 *
 * @since 1911
 */
public class ProductNameAttributeMapper extends TmaAttributeMapper<OrderEntryData, Product>
{
	@Override
