 ...
 * @since 1907
 */
public class GeographicAddressCityAttributeMapper extends TmaAttributeMapper<AddressData, GeographicAddress>
{
	@Override
	public void populateTargetAttributeFromSource(AddressData source, GeographicAddress target, MappingContext context)
	{
		if (StringUtils.isNotEmpty(source.getTown()))
		{
	...
	{
		if (StringUtils.isNotEmpty(target.getCity()))
		{
			source.setTown(target.getCity());
		}
	}
}
