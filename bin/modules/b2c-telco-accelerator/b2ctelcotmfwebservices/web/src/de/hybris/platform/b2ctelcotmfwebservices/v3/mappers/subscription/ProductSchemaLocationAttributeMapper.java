...
/**
 * This attribute Mapper class maps data for atschemaLocation attribute for Subscription between
 * {@link TmaSubscriptionBaseData} and {@link Product}
 *
 * @since 2102
 */
public class ProductSchemaLocationAttributeMapper extends TmaAttributeMapper<TmaSubscriptionBaseData, Product>
{
	@Override
