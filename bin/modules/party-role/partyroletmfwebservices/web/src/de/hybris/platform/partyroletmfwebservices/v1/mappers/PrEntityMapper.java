 ...
 * @since 2108
 */
public class PrEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	/**
	 * Source class
	 */
	 ...
	 */
	private List<PrAttributeMapper<SOURCE, TARGET>> attributeMappers;

	public PrEntityMapper(final Class<SOURCE> sourceClass, final Class<TARGET> targetClass,
			final List<PrAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
	...
	@SuppressWarnings("WeakerAccess")
	protected List<PrAttributeMapper<SOURCE, TARGET>> getAttributeMappers()
	{
