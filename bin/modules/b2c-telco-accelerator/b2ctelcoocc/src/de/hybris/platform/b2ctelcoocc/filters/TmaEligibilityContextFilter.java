 ...
 */
package de.hybris.platform.b2ctelcoocc.filters;
...
public class TmaEligibilityContextFilter extends OncePerRequestFilter
{
	...
	protected boolean hasAdminRole()
	{
		final List<String> eligibilityAdminRoles = Arrays
				.asList(getConfigurationService().getConfiguration().getString(B2ctelcooccConstants.ELIGIBILTY_ROLES).split(REGEX));
