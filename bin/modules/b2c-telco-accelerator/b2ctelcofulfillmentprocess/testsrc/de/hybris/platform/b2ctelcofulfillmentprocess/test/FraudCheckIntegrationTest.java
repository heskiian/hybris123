...
import de.hybris.platform.b2ctelcofulfillmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/b2ctelcofulfillmentprocess/test/b2ctelcofulfillmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "b2ctelcofulfillmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "b2ctelcofulfillmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "b2ctelcofulfillmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/b2ctelcofulfillmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/b2ctelcofulfillmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = B2ctelcofulfillmentprocessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				B2ctelcofulfillmentprocessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				B2ctelcofulfillmentprocessConstants.ORDER_PROCESS_NAME);
