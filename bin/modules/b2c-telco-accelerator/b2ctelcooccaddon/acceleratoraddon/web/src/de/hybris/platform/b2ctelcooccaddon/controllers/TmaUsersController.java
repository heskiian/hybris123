...
public class TmaUsersController extends BaseController
{
	...
	@RequestMappingOverride(priorityProperty = "b2ctelcooccaddon.TmaUsersController.createUser.priority")
			...
			final HttpServletRequest httpRequest, final HttpServletResponse httpResponse)
	{
		...
		httpResponse.setHeader(B2ctelcooccaddonControllerConstants.LOCATION, getAbsoluteLocationURL(httpRequest, userId)); //NOSONAR
	...
	protected String getAbsoluteLocationURL(final HttpServletRequest httpRequest, final String uid)
	{
		...
		if (!requestURL.endsWith(B2ctelcooccaddonControllerConstants.SLASH))
		{
			absoluteURLSb.append(B2ctelcooccaddonControllerConstants.SLASH);
		}
