...
/**
 * This attribute Mapper class maps data for atType attribute between {@link UcUsageVolumeProductModel} and
 * {@link UsageVolumeProduct}
 *
 * @since 2108
 */
public class UsageVolumeProductAtTypeAttributeMapper extends UcAttributeMapper<UcUsageVolumeProductModel, UsageVolumeProduct>
{
	public UsageVolumeProductAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.setAtbaseType(UsageconsumptiontmfwebservicesConstants.UC_USAGE_VOLUME_PRODUCT_TYPE);
		}
	}
}