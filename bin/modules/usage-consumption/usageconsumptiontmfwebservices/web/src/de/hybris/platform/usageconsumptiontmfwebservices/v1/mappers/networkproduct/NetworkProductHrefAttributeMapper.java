...
/**
 * This attribute Mapper class maps data for href attribute between {@link UcConsumptionSummaryModel} and
 * {@link ConsumptionSummary}
 *
 * @since 2108
 */
public class NetworkProductHrefAttributeMapper extends UcAttributeMapper<UcNetworkProductModel, NetworkProduct>
{
	public NetworkProductHrefAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
