...
/**
 * This attribute Mapper class maps data for href attribute between {@link SpiRelatedPlaceModel} and {@link RelatedPlaceRefOrValue}
 *
 * @since 2105
 */
public class RelatedPlaceRefOrValueHrefAttributeMapper extends SpiAttributeMapper<SpiRelatedPlaceModel, RelatedPlaceRefOrValue>
{
	public RelatedPlaceRefOrValueHrefAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
			...
			final MappingContext context)
	{
		...
		{
			target.setHref(SubscribedproducttmfwebservicesConstants.RELATED_PLACE_API_URL + source.getId());
		}
	}
}
