...
/**
 * This attribute Mapper class maps data for atType attribute between {@link BmAppliedPartyBillingTaxRateModel} and {@link TaxItem}
 *
 * @since 2108
 */
public class TaxItemAtTypeAttributeMapper extends BmAttributeMapper<BmAppliedPartyBillingTaxRateModel, TaxItem>
{
	public TaxItemAtTypeAttributeMapper(final String sourceAttributeName, final String targetAttributeName)
	{
