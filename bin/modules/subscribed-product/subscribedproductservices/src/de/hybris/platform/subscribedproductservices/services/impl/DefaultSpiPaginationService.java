...
/**
 * Default implementation of {@link SpiPaginationService}.
 *
 * @since 2105
 */
public class DefaultSpiPaginationService implements SpiPaginationService
{
	...
	{
		return Integer.valueOf(Config.getParameter(SubscribedproductservicesConstants.PAGINATION_DEFAULT_LIMIT));
	}
