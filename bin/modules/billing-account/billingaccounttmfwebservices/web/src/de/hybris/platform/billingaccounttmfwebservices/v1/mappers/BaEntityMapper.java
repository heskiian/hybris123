 ...
 * @since 2105
 */
public class BaEntityMapper<SOURCE, TARGET> extends AbstractCustomMapper<SOURCE, TARGET>
{
	/**
	 * Source class
	 */
	 ...
	 */
	private List<BaAttributeMapper<SOURCE, TARGET>> attributeMappers;

	public BaEntityMapper(final Class<SOURCE> sourceClass, final Class<TARGET> targetClass,
			final List<BaAttributeMapper<SOURCE, TARGET>> attributeMappers)
	{
	...
	@SuppressWarnings("WeakerAccess")
	protected List<BaAttributeMapper<SOURCE, TARGET>> getAttributeMappers()
	{
